...
if __name__ == "__main__":
    ...
    joint_results_df.to_parquet(OUTPUT_DIR / 'estimated_parameters_joint_validity_math500.parquet', index=False)

    print("Saving IRT model results to parquet...")
    irt_results_df.to_parquet(OUTPUT_DIR / 'estimated_parameters_irt_validity_math500.parquet', index=False)
