...
binary_df_math500 = pd.read_csv(DATA_DIR / 'correctness_matrix_combined.csv', index_col=0)
cot_df_math500 = pd.read_csv(DATA_DIR / 'cot_length_matrix_combined.csv', index_col=0)
...
# theta_irt = estimated_parameters['theta_irt_train']
